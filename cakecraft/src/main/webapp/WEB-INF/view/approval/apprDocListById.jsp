...
jQuery(document).ready(function($) {
	...
	var mydata = [ //데이터
		...
		{no: "${ad.documentNo}", cd: "${ad.documentNm}", subcd: "${ad.documentSubNm}", title: "${ad.documentTitle}", modDtime: "${ad.modDtime}", status: "${ad.approvalStatus}"},
		</c:forEach>
	];
					...
					<div class="col-md-12 col-sm-12">
						...
						<nav aria-label="breadcrumb" role="navigation">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">기안문서</li>
							</ol>
						</nav>
					</div>
				</div>
